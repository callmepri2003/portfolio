...
function process(Quform $form, array &$config)
{
    ...
    if ($form->isValid($_POST)) {
        // upload code section #1 - see documentation for examples

        // End upload code section #1
        ...
        try {
            ...
            // upload code section #2 - see documentation for examples

            // End upload code section #2
        } catch (Exception $e) {
            if (QUFORM_DEBUG) {
                throw $e;
            }
